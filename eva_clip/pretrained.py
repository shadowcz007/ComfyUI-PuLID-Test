...
def download_pretrained_from_hf(
    ...
    has_hf_hub(True)
    print('#download_pretrained_from_hf',model_id, filename,cache_dir)
    p=os.path.join(cache_dir,model_id, filename)
    if os.path.exists(p):
        return p
    cached_file = hf_hub_download(model_id, filename, cache_dir=cache_dir,endpoint='https://hf-mirror.com')
    return cached_file
